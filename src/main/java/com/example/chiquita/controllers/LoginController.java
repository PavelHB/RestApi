...
public class LoginController {
    ...
    public LoginController(UserService userService, AuthenticationManager authenticationManager, JwtUtils jwtUtils, JwtRefreshUtils jwtRefreshUtils) {
    ...
    public ResponseEntity<Object> login(@RequestBody JwtRequest jwtRequest) {
        ...
        return ResponseEntity.ok().body(new JwtResponse(token,refreshToken,userDetails));
    }
}
